...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
      <path fill="#4285F4" d="M23.766 12.276c0-.818-.074-1.606-.212-2.364H12.24v4.472h6.482a5.54 5.54 0 0 1-2.402 3.632v3.016h3.887c2.275-2.094 3.559-5.176 3.559-8.756z" />
      <path fill="#34A853" d="M12.24 24c3.24 0 5.956-1.075 7.941-2.908l-3.887-3.016c-1.076.72-2.454 1.145-4.054 1.145-3.12 0-5.762-2.107-6.705-4.938H1.516v3.11A11.997 11.997 0 0 0 12.24 24z" />
      <path fill="#FBBC05" d="M5.535 14.283A7.19 7.19 0 0 1 5.161 12c0-.793.137-1.563.374-2.283V6.607H1.516A11.997 11.997 0 0 0 .24 12c0 1.936.463 3.767 1.276 5.393l4.02-3.11z" />
      <path fill="#EA4335" d="M12.24 4.78c1.762 0 3.344.606 4.588 1.795l3.442-3.442C18.192 1.19 15.476 0 12.24 0A11.997 11.997 0 0 0 1.516 6.607l4.02 3.11c.943-2.83 3.585-4.938 6.705-4.938z" />
    </svg>
  );
}
